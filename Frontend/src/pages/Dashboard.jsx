...
export default function Dashboard({ language = "en" }) {
  ...
  const labels = isHebrew
    ? {
        ...
        loadingDashboard: "טוען נתוני לוח מחוונים...",
        users: "משתמשים",
        groups: "קבוצות",
        meetings: "ישיבות",
        memberships: "שיוכי קבוצות",
        snapshot: "תמונת מצב פעילות קבוצות",
        noGroups: "לא נמצאו קבוצות.",
        members: "חברים",
        favoriteMeetings: "ישיבות מועדפות",
        refresh: "רענן",
        loading: "טוען...",
        saved: "שמורות",
        noFavorites: "אין ישיבות מועדפות עדיין.",
